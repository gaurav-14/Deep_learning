...
##            return
    ...
    def loadImage(self):
        ...
        self.mainPanel.config(width = max(self.tkimg.width(), 600), height = max(self.tkimg.height(), 600))
        ...
        if os.path.exists(self.labelfilename):
            with open(self.labelfilename) as f:
                for (i, line) in enumerate(f):
                    ...
                    #swapped x with y while creating rectangle as values in file are in order[ymin,xmin,ymax,xmax]
